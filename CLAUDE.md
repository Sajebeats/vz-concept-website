...
Dies ist der **Projekt-Workspace für vz-concept.de** — die Website von Vanessa Zimmer (Gründungs- und Unternehmensberaterin). Dennis (Web-Entwickler) arbeitet hier mit Claude zusammen um die Website zu bauen und zu pflegen.

**Stack:** Static HTML/CSS/JS → GitHub Pages → vz-concept.de  
**Repo:** github.com/Sajebeats/vz-concept-website  
**Lokaler Arbeitsordner:** `C:\Users\Anwender\Desktop\Vanessa Zimmer\WebsiteV3\Website\`
